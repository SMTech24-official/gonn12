...
const createSessionCourt = async (payload: {
  sessionId: string
  courtId: string
}) => {
...
const createSessionCourts = async (sessionId: string, courtIds: string[]) => {
  const createdSessionCourts = await Promise.all(
